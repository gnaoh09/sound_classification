...
def apply_mfcc_to_folder(folder_path):
    ...
    for file_name in os.listdir(folder_path):
        if file_name.endswith('.wav'):
            ...
            sound_data.append({'File Name': file_name, 'MFCC': mfcc})
    return sound_data
...
# Train the model
history = model.fit(X_train_cnn_lstm, y_train, epochs=500, batch_size=32, validation_data=(X_test_cnn_lstm, y_test))
